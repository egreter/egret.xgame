...
*************************************************/
module egretx {
    export class SceneRotateTransition extends SceneTransition {
        ...
        public start(scene: egret.DisplayObject): Promise<void> {
            return new Promise((resolve, reject) => {
                ...
                for (let i = 0; i < count_blocks; i++) {
                    ...
                    tw.wait(time_random).to({ scaleX: 0, scaleY: 0, alpha: 0, rotation: 359 }, time_transition, egret.Ease.circIn).call(onComplete, this, [bmp]);
                }
