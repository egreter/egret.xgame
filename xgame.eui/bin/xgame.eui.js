...
(function (euix) {
    xgame.XGame.prototype["useEUI"] = function (main) {
        var self = this;
        self.registerServiceProvider(new euix.EUIProvider(main));
    };
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
...
(function (euix) {
    euix.IUIManager = Symbol.for("euix.IUIManager");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    euix.IUIManagerInternal = Symbol.for("euix.IUIManagerInternal");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var EUIProvider = (function (_super) {
        __extends(EUIProvider, _super);
        function EUIProvider(main) {
            var _this = _super.call(this) || this;
            _this.main = main;
            _this.priority = 100;
            return _this;
        }
        EUIProvider.prototype.onInit = function (game) {
        ...
        EUIProvider.prototype.onStart = function (game) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    game.getService(euix.IUIManagerInternal).initialize();
                    game.getService(euix.ITouchManagerInternal).initialize();
                    return [2 /*return*/, true];
                });
            });
        };
    ...
    euix.EUIProvider = EUIProvider;
    __reflect(EUIProvider.prototype, "euix.EUIProvider", ["xgame.IServiceProvider"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    euix.injectable = xgame.injectable;
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    euix.ITouchManager = Symbol.for("ITouchManager");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    euix.ITouchManagerInternal = Symbol.for("ITouchManagerInternal");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    euix.TOUCH_TAP_BETWEEN_TIME = 300;
    euix.TOUCH_LONG_PRESS_TIME = 300;
    euix.TOUCH_SCALE_RADIO = 0.96;
    euix.touchClickLastTime = 0;
    var TouchManager = (function (_super) {
        ...
        TouchManager.prototype.addTouchBegin = function (target, listener, thisObject, scale) {
            ...
            var delegate = this.delegates.allocf(guid, function () {
                return new euix.TouchDelegate(target, scale);
            });
        ...
        TouchManager.prototype.removeTouchBegin = function (target, listener, thisObject) {
            ...
            var delegate = this.delegates.allocf(guid, function () {
                return new euix.TouchDelegate(target);
            });
        ...
        TouchManager = __decorate([
            xgame.impl(xgame.IDisposable, euix.ITouchManager, euix.ITouchManagerInternal),
            __metadata("design:paramtypes", [egret.DisplayObjectContainer])
        ], TouchManager);
        return TouchManager;
    }(xgame.XObject));
    euix.TouchManager = TouchManager;
    __reflect(TouchManager.prototype, "euix.TouchManager", ["xgame.IDisposable", "xgame.IXObject", "euix.ITouchManager", "euix.ITouchManagerInternal"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.LayoutCache = LayoutCache;
    __reflect(LayoutCache.prototype, "euix.LayoutCache");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var TouchBehaviours = (function () {
        ...
        TouchBehaviours.prototype.setTouchManager = function (target) {
            ...
            this.disposableGroup = new euix.TouchDisposableGroup(target);
        };
    ...
    euix.TouchBehaviours = TouchBehaviours;
    __reflect(TouchBehaviours.prototype, "euix.TouchBehaviours");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var TouchDelegate = (function (_super) {
        ...
        function TouchDelegate(target, scale) {
            ...
            _this.longPressTimeDelta = euix.TOUCH_LONG_PRESS_TIME;
            _this.repeatPressTimeDelta = euix.TOUCH_LONG_PRESS_TIME;
        ...
        TouchDelegate.prototype.cacheLayout = function () {
            if (!this.cache) {
                this.cache = new euix.LayoutCache();
            }
        ...
        TouchDelegate.prototype.updateLayout = function (isUp) {
            ...
            if (isUp) {
                ...
                this.target.scaleX = this.cache.scaleX * euix.TOUCH_SCALE_RADIO;
                this.target.scaleY = this.cache.scaleY * euix.TOUCH_SCALE_RADIO;
                if (this.target instanceof eui.Component) {
                    this.target.top = NaN;
        ...
        TouchDelegate.prototype.onTouchEnd = function (event) {
            ...
            if (event.type == egret.TouchEvent.TOUCH_RELEASE_OUTSIDE) {
                ...
                if (!this.longPressHandler.happend && !this.repeatPressHandler.happend) {
                    if (end_time - euix.touchClickLastTime > euix.TOUCH_TAP_BETWEEN_TIME) {
                        euix.touchClickLastTime = end_time;
    ...
    euix.TouchDelegate = TouchDelegate;
    __reflect(TouchDelegate.prototype, "euix.TouchDelegate", ["xgame.IDisposable", "xgame.IXObject"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var TouchDisposableGroup = (function (_super) {
        ...
        __decorate([
            xgame.inject(euix.ITouchManager),
            __metadata("design:type", euix.TouchManager)
        ], TouchDisposableGroup.prototype, "manager", void 0);
        return TouchDisposableGroup;
    }(xgame.XObject));
    euix.TouchDisposableGroup = TouchDisposableGroup;
    __reflect(TouchDisposableGroup.prototype, "euix.TouchDisposableGroup", ["xgame.IDisposable", "xgame.IXObject"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var UIManager = (function (_super) {
        ...
        UIManager.prototype.initialize = function () {
            this.$entityManager = new euix.UIEntityManager(this);
            ...
            for (var i = euix.UILayerID.Layer_0_Bottom; i <= euix.UILayerID.Layer_15_Top; i++) {
                var layerManager = new euix.UILayerManager(this, i);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (this.$entityManager.tryGetEntities(options.uiClass, results)) {
                        entity = results[0];
                        if (entity.uiPage.flags & euix.UIFlags.allowMultiple) {
                        }
                        else {
                            ...
                            if (options.hud) {
                                uiPage_1.renderWatcher.onChanged().add(function () {
                                    egret.callLater(function () {
                                        euix.TipsHelper.placeTipsWithHUD(uiPage_1, options.hud, options.gap);
                                    }, _this);
                                }, this);
                            }
                            if (options.uiRoot) {
                                ...
                                if (uiPage_1.flags & euix.UIFlags.useMask) {
        ...
        UIManager = __decorate([
            xgame.impl(euix.IUIManager, euix.IUIManagerInternal),
            __metadata("design:paramtypes", [egret.DisplayObjectContainer])
        ], UIManager);
        return UIManager;
    }(xgame.XObject));
    euix.UIManager = UIManager;
    __reflect(UIManager.prototype, "euix.UIManager", ["euix.IUIManager", "xgame.IXObject", "euix.IUIManagerInternal"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var Group = (function (_super) {
        ...
        Group = __decorate([
            xgame.mixin(euix.TouchBehaviours),
            __metadata("design:paramtypes", [])
        ], Group);
        return Group;
    }(eui.Group));
    euix.Group = Group;
    __reflect(Group.prototype, "euix.Group", ["xgame.IXObject"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.ItemRenderer = ItemRenderer;
    __reflect(ItemRenderer.prototype, "euix.ItemRenderer");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.UIComponent = UIComponent;
    __reflect(UIComponent.prototype, "euix.UIComponent", ["xgame.IXObject", "eui.UIComponent", "egret.DisplayObject"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    })(UIAlign = euix.UIAlign || (euix.UIAlign = {}));
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    })(UIDirection = euix.UIDirection || (euix.UIDirection = {}));
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var UIPage = (function (_super) {
        ...
        function UIPage(skinPath) {
            ...
            //UI的类型参数,见UIFlags
            _this.flags = euix.UIFlags.isStack | euix.UIFlags.isFullScreen;
            ...
            //UI的层级ID
            _this.$layerID = euix.UILayerID.Layer_5_UI;
            return _this;
        }
        ...
        __decorate([
            euix.inject(euix.IUIManager),
            __metadata("design:type", Object)
        ], UIPage.prototype, "uiManager", void 0);
        __decorate([
            euix.inject(egretx.IGuideManager),
            __metadata("design:type", Object)
        ], UIPage.prototype, "guideManager", void 0);
        __decorate([
            euix.inject(egretx.IAnimationManager),
            __metadata("design:type", Object)
        ], UIPage.prototype, "animationManager", void 0);
        __decorate([
            euix.inject(egretx.IAudioManager),
            __metadata("design:type", Object)
        ], UIPage.prototype, "audioManager", void 0);
        return UIPage;
    }(euix.UIComponent));
    euix.UIPage = UIPage;
    __reflect(UIPage.prototype, "euix.UIPage");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var PluginPage = (function (_super) {
        ...
        function PluginPage(skinPath) {
            ...
            _this.flags = euix.UIFlags.isPlugin;
            return _this;
        }
        return PluginPage;
    }(euix.UIPage));
    euix.PluginPage = PluginPage;
    __reflect(PluginPage.prototype, "euix.PluginPage");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.Window = Window;
    __reflect(Window.prototype, "euix.Window");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    })(UILayerID = euix.UILayerID || (euix.UILayerID = {}));
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.RenderWatcher = RenderWatcher;
    __reflect(RenderWatcher.prototype, "euix.RenderWatcher");
    var Popup = (function (_super) {
        ...
        function Popup(skinPath) {
            ...
            _this.$uiDirection = euix.UIDirection.ANY;
            _this.$uiAlign = euix.UIAlign.CENTER;
            _this.flags = euix.UIFlags.isStack | euix.UIFlags.isPopupMenu | euix.UIFlags.useMask | euix.UIFlags.closeByMask | euix.UIFlags.allowMultiple;
            _this.setLayerID(euix.UILayerID.Layer_10_Popup);
            _this.$maskAlpha = 0;
    ...
    euix.Popup = Popup;
    __reflect(Popup.prototype, "euix.Popup");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.Scene = Scene;
    __reflect(Scene.prototype, "euix.Scene");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.UIEntity = UIEntity;
    __reflect(UIEntity.prototype, "euix.UIEntity", ["euix.IUIEntity", "xgame.IDisposable", "xgame.IXObject"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var UIHelper = (function () {
        ...
        UIHelper.isFullScreenUI = function (entity) {
            ...
            if (!(flags & euix.UIFlags.isStack)) {
                return false;
            }
            if (!(flags & euix.UIFlags.isFullScreen)) {
                return false;
            }
            return true;
        };
        ...
        UIHelper.isPopupMenuUI = function (entity) {
            ...
            if (flags & euix.UIFlags.isPopupMenu) {
                return true;
            }
            return false;
        };
        UIHelper.isPluginUI = function (entity) {
            var flags = entity.uiPage.flags;
            if (flags & euix.UIFlags.isPlugin) {
                return true;
            }
            return false;
        };
    ...
    euix.UIHelper = UIHelper;
    __reflect(UIHelper.prototype, "euix.UIHelper");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var UIEntityManager = (function (_super) {
        ...
        Object.defineProperty(UIEntityManager.prototype, "topFullScreenUI", {
            get: function () {
                ...
                while (index >= 0) {
                    ...
                    if (entity.uiPage.flags & euix.UIFlags.isFullScreen) {
                        return entity;
                    }
                    index--;
                }
        ...
        Object.defineProperty(UIEntityManager.prototype, "hasPopUp", {
            get: function () {
                ...
                while (index >= 0) {
                    var entity = this.stackList.elementAt(index);
                    if (euix.UIHelper.isWindowUI(entity)) {
                        return true;
                    }
                    index--;
                }
        ...
        UIEntityManager.prototype.hideUIUnderLayers = function () {
            ...
            this.manager.uiLayers.forKeys(function (layerID) {
                if (layerID >= euix.UILayerID.Layer_5_UI) {
                    return true;
                }
    ...
    euix.UIEntityManager = UIEntityManager;
    __reflect(UIEntityManager.prototype, "euix.UIEntityManager");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.UILayerManager = UILayerManager;
    __reflect(UILayerManager.prototype, "euix.UILayerManager");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.UIResManager = UIResManager;
    __reflect(UIResManager.prototype, "euix.UIResManager");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    function alert(message_or_options, title, buttons_or_nums_or_closeByMask, closeByMask) {
        ...
        xgame.that.getService(euix.IUIManager).openUI(Alert, options);
    ...
    var Alert = (function (_super) {
        ...
        function Alert(options) {
            ...
            if (!_this.options.closeByMask) {
                _this.flags &= ~euix.UIFlags.closeByMask;
            }
    ...
    euix.Alert = Alert;
    __reflect(Alert.prototype, "euix.Alert");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.get_measure_width = get_measure_width;
    var bits = 1;
    var InvalidateFlags;
    ...
    var DropdownList = (function (_super) {
        ...
        DropdownList.prototype.openPopup = function () {
            ...
            this.options = {
                ...
                allowDirections: [euix.UIDirection.BOTTOM, euix.UIDirection.TOP],
                uiDirection: euix.UIDirection.ANY,
                minWidth: this.width,
            ...
            euix.showPopupMenu(this, this.options).addOnce(function (item) {
                if (item) {
    ...
    euix.DropdownList = DropdownList;
    __reflect(DropdownList.prototype, "euix.DropdownList", ["xgame.IPoolable", "xgame.IDisposable"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    var DropdownListGroup = (function (_super) {
        ...
        function DropdownListGroup() {
            ...
            _this.items = [];
            _this.pools = new xgame.PoolObject(euix.DropdownList);
            return _this;
        }
    ...
    euix.DropdownListGroup = DropdownListGroup;
    __reflect(DropdownListGroup.prototype, "euix.DropdownListGroup");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.PopupMenuEvent = PopupMenuEvent;
    __reflect(PopupMenuEvent.prototype, "euix.PopupMenuEvent");
    ...
    euix.PopupMenuItem = PopupMenuItem;
    __reflect(PopupMenuItem.prototype, "euix.PopupMenuItem");
    var PopupMenu = (function (_super) {
        ...
        function PopupMenu(options) {
            ...
            if (options.uiDirection == undefined) {
                options.uiDirection = euix.UIDirection.BOTTOM;
            }
            if (options.uiAlign == undefined) {
                options.uiAlign = euix.UIAlign.CENTER;
            }
        ...
        PopupMenu.prototype.updateArrow = function (direction) {
            ...
            else if (direction == euix.UIDirection.LEFT) {
    ...
    euix.PopupMenu = PopupMenu;
    __reflect(PopupMenu.prototype, "euix.PopupMenu");
    function showPopupMenu(target, titles_or_options) {
        ...
        xgame.that.getService(euix.IUIManager).openPopup(PopupMenu, target, options);
        return options.callback;
    }
    euix.showPopupMenu = showPopupMenu;
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    })(TipsState = euix.TipsState || (euix.TipsState = {}));
    ...
    euix.TipsView = TipsView;
    __reflect(TipsView.prototype, "euix.TipsView", ["euix.ITipsView", "xgame.IPoolable", "xgame.IDisposable", "xgame.IXObject"]);
    var TipsManager = (function (_super) {
        ...
        TipsManager.prototype.initialize = function () {
            ...
            var parent = xgame.that.getService(euix.IUIManager).getLayerManager(euix.UILayerID.Layer_12_Toast);
            parent.addChild(this.$container);
        };
        return TipsManager;
    }(xgame.Singleton));
    euix.TipsManager = TipsManager;
    __reflect(TipsManager.prototype, "euix.TipsManager");
...
(function (euix) {
    ...
    euix.UIOptions = UIOptions;
    __reflect(UIOptions.prototype, "euix.UIOptions");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    euix.ISceneTransition = Symbol.for("ISceneTransition");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var SceneTransition = (function (_super) {
        ...
        SceneTransition = __decorate([
            xgame.impl(euix.ISceneTransition),
            __metadata("design:paramtypes", [])
        ], SceneTransition);
        return SceneTransition;
    }(xgame.XObject));
    euix.SceneTransition = SceneTransition;
    __reflect(SceneTransition.prototype, "euix.SceneTransition", ["euix.ISceneTransition", "xgame.IXObject"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    var SceneFadeTransition = (function (_super) {
        ...
        function SceneFadeTransition(blockSize, duration, style) {
            ...
            if (style === void 0) { style = euix.SceneMotion.RANDOM; }
            var _this = _super.call(this) || this;
        ...
        SceneFadeTransition.prototype.start = function (scene) {
            ...
            return new Promise(function (resolve, reject) {
                var layerManager = _this.uiManager.getLayerManager(euix.UILayerID.Layer_3_SceneMask);
                ...
                for (var i = 0; i < count_blocks; i++) {
                    ...
                    var bmp = euix.BitmapPools.Instance().fetch();
                    bmp.alpha = 1;
                    ...
                    var time_random = 0;
                    if (_this.style == euix.SceneMotion.TOP) {
                        time_random = i * 10;
                    }
                    else if (_this.style == euix.SceneMotion.BOTTOM) {
                        time_random = (count_blocks - 1 - i) * 10;
                    }
                    else if (_this.style == euix.SceneMotion.LEFT) {
                        time_random = col * count_rows * 10 + row * 10;
                    }
                    else if (_this.style == euix.SceneMotion.RIGHT) {
                        time_random = (count_cols - col) * count_rows * 10 + row * 10;
                    }
                    else if (_this.style == euix.SceneMotion.TOP_LEFT) {
                        time_random = col * row * 10;
                    }
                    else if (_this.style == euix.SceneMotion.TOP_RIGHT) {
                        time_random = (count_cols - col) * row * 10;
                    }
                    else if (_this.style == euix.SceneMotion.BOTTOM_LEFT) {
                        time_random = col * (count_rows - row) * 10;
                    }
                    else if (_this.style == euix.SceneMotion.BOTTOM_RIGHT) {
                ...
                function onComplete(bmp) {
                    euix.BitmapPools.Instance().recycle(bmp);
                    count_completed++;
    ...
    }(euix.SceneTransition));
    euix.SceneFadeTransition = SceneFadeTransition;
    __reflect(SceneFadeTransition.prototype, "euix.SceneFadeTransition");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.SceneHShuttersTransition = SceneHShuttersTransition;
    __reflect(SceneHShuttersTransition.prototype, "euix.SceneHShuttersTransition");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    })(SceneMotion = euix.SceneMotion || (euix.SceneMotion = {}));
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.SceneRotateTransition = SceneRotateTransition;
    __reflect(SceneRotateTransition.prototype, "euix.SceneRotateTransition");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.SceneScaleTransition = SceneScaleTransition;
    __reflect(SceneScaleTransition.prototype, "euix.SceneScaleTransition");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.SceneVShuttersTransition = SceneVShuttersTransition;
    __reflect(SceneVShuttersTransition.prototype, "euix.SceneVShuttersTransition");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.UIFadeTransition = UIFadeTransition;
    __reflect(UIFadeTransition.prototype, "euix.UIFadeTransition", ["euix.IUITransition", "xgame.IXObject"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.UIScaleTransition = UIScaleTransition;
    __reflect(UIScaleTransition.prototype, "euix.UIScaleTransition", ["euix.IUITransition", "xgame.IXObject"]);
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    euix.Bitmap = Bitmap;
    __reflect(Bitmap.prototype, "euix.Bitmap", ["xgame.IPoolable", "xgame.IDisposable", "xgame.IXObject"]);
    ...
    euix.BitmapPools = BitmapPools;
    __reflect(BitmapPools.prototype, "euix.BitmapPools");
})(euix || (euix = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (euix) {
    ...
    var TipsHelper = (function () {
        ...
        TipsHelper.placeTipsWithHUD = function (tips, hud, gap) {
            ...
            var uiManager = xgame.that.getService(euix.IUIManager);
            ...
            var bottom = top + hh;
            //尝试放置到下边
            if (tips.allowUIDirection(euix.UIDirection.BOTTOM) && ((screenHeight - bottom - 2 * gap >= th && direction == euix.UIDirection.ANY) || direction == euix.UIDirection.BOTTOM)) {
                tips.y = bottom + gap;
                if (align == euix.UIAlign.LEFT) {
                    tips.x = left;
                }
                else if (align == euix.UIAlign.RIGHT) {
                    tips.x = right - tw;
                }
                else {
                    tips.x = left + hw / 2 - tw / 2;
                }
                tips.fixedUIDirection(euix.UIDirection.BOTTOM);
            }
            else if (tips.allowUIDirection(euix.UIDirection.TOP) && ((top - 2 * gap >= th && direction == euix.UIDirection.ANY) || direction == euix.UIDirection.TOP)) {
                tips.y = top - gap - th;
                if (align == euix.UIAlign.LEFT) {
                    tips.x = left;
                }
                ...
                tips.fixedUIDirection(euix.UIDirection.TOP);
            }
            else if (tips.allowUIDirection(euix.UIDirection.RIGHT) && ((screenWidth - right - 2 * gap >= tw && direction == euix.UIDirection.ANY) || direction == euix.UIDirection.RIGHT)) {
                tips.x = right + gap;
                if (align == euix.UIAlign.TOP) {
                    tips.y = top;
                }
                else if (align == euix.UIAlign.BOTTOM) {
                    tips.y = top + hh - th;
                }
                else {
                    tips.y = top + hh / 2 - th / 2;
                }
                tips.fixedUIDirection(euix.UIDirection.RIGHT);
            }
            else if (tips.allowUIDirection(euix.UIDirection.LEFT) && ((left - 2 * gap >= tw && direction == euix.UIDirection.ANY) || direction == euix.UIDirection.LEFT)) {
                tips.x = left - gap - tw;
                if (align == euix.UIAlign.TOP) {
                    tips.y = top;
                }
                ...
                tips.fixedUIDirection(euix.UIDirection.LEFT);
            }
    ...
    euix.TipsHelper = TipsHelper;
    __reflect(TipsHelper.prototype, "euix.TipsHelper");
})(euix || (euix = {}));
