...
module euix {
    ...
    export class TipsView extends eui.Component implements ITipsView {
    ...
    export class TipsManager extends xgame.Singleton {
        ...
        public get container(): eui.Group {
        ...
        public initialize(): void {
            ...
            let parent = xgame.that.getService<IUIManager>(IUIManager).getLayerManager(UILayerID.Layer_12_Toast);
