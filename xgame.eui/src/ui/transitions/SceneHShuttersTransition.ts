...
*************************************************/
module euix {
    export class SceneHShuttersTransition extends SceneTransition {
        ...
        public start(scene: egret.DisplayObject): Promise<void> {
            return new Promise((resolve, reject) => {
                ...
                for (let i = 0; i < count_blocks; i++) {
                    ...
                    tw.to({ scaleX: 1, scaleY: 0.2, alpha: 0 }, time_transition, egret.Ease.circIn).call(onComplete, this, [bmp]);
                }
