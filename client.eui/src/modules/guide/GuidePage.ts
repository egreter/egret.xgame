...
export class GuidePage extends euix.PluginPage {
    ...
    protected placeWithTarget(): void {
        ...
        if (screenHeight - bottom - 2 * gap >= th) {
            ...
            com_arrow.setDirection(euix.UIDirection.BOTTOM, offset);
        }
        //尝试放置到上边
            ...
            com_arrow.setDirection(euix.UIDirection.TOP, offset);
        }
