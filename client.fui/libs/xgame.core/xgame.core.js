...
(function (xgame) {
    var XProvider = (function (_super) {
        ...
        XProvider.prototype.onStart = function (game) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    game.getService(xgame.ITimelineManagerInternal).initialize();
                    return [2 /*return*/, true];
                });
            });
        };
        XProvider.prototype.onServiceRegister = function (game) {
            ...
            game.singleton(xgame.ITimelineManager, xgame.TimelineManager).withInstance(xgame.TimelineManager.Instance()).setAlias(xgame.ITimelineManagerInternal);
            console.log("[XProvider]: 注册管理器{0}".format(xgame.getQualifiedClassName(xgame.TimelineManager)));
        };
...
(function (xgame) {
    ...
    var TimelineManager = (function (_super) {
        ...
        TimelineManager.prototype.getOrCreateTimeline = function (name) {
            if (name === void 0) { name = xgame.Timeline.MAIN; }
            if (!this.timelines.containsKey(name)) {
                this.timelines.add(name, new xgame.Timeline(name));
            }
            return this.timelines.get(name);
        };
        return TimelineManager;
    }(xgame.Singleton));
    xgame.TimelineManager = TimelineManager;
    __reflect(TimelineManager.prototype, "xgame.TimelineManager", ["xgame.ITimelineManager", "xgame.ITimelineManagerInternal"]);
})(xgame || (xgame = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (xgame) {
    ...
    xgame.Timeline = Timeline;
    __reflect(Timeline.prototype, "xgame.Timeline");
})(xgame || (xgame = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (xgame) {
    xgame.ITimelineManager = Symbol.for("ITimelineManager");
})(xgame || (xgame = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
...
(function (xgame) {
    xgame.ITimelineManagerInternal = Symbol.for("ITimelineManagerInternal");
})(xgame || (xgame = {}));
/*************************************************
/* @author : rontian
/* @email  : i@ronpad.com
