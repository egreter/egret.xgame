    ...
    export class Signal5<T1, T2, T3, T4, T5> extends SignalBase {
        public dispatch(o1: T1, o2: T2, o3: T3, o4: T4, o5: T5): void {
            ...
            for (node = this.head; node; node = node.next) {
                let cancel = node.execute(o1, o2, o3, o4, o5);
                if (node.once) {
        ...
        public add(listener: (o1: T1, o2: T2, o3: T3, o4: T4, o5: T5) => void, thisObject: any = null, priority: number = 0): void {
            super.add(listener, thisObject, priority);
        }
        public addOnce(listener: (o1: T1, o2: T2, o3: T3, o4: T4, o5: T5) => void, thisObject: any = null, priority: number = 0): void {
