...
namespace Reflect {
    ...
    (function (this: any, factory: (exporter: <K extends keyof typeof Reflect>(key: K, value: typeof Reflect[K]) => void) => void) {
        ...
        (function (exporter) {
            ...
            const toPrimitiveSymbol = supportsSymbol && typeof (Symbol as any).toPrimitive !== "undefined" ? (Symbol as any).toPrimitive : "@@toPrimitive";
            const iteratorSymbol = supportsSymbol && typeof (Symbol as any).iterator !== "undefined" ? (Symbol as any).iterator : "@@iterator";
